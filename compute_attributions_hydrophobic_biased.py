...
def main(args):
    ...
    X_actives_plec = np.load(f'{args.root_dir}/actives/features_plec.npy', allow_pickle = True)
    X_inactives_plec = np.load(f'{args.root_dir}/decoys/features_plec.npy', allow_pickle = True)

    y_actives = np.load(f'{args.root_dir}/actives/labels.npy')
    y_inactives = np.load(f'{args.root_dir}/decoys/labels.npy')
