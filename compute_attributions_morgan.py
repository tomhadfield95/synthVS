...
from RF_attribution_masking import get_masking_ranking_dataframe_morgan
import os
import joblib
...
def main(args):
    ...
    '''
    out_df = get_masking_ranking_dataframe_morgan([args.sdf_ligand, args.sdf_pharm], RF_model = clf, 
                                           binding_threshold = args.binding_threshold, hydrophobic = args.hydrophobic)
